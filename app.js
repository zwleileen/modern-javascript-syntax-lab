...
console.log("Exercise 7: refer to exportingFile.js and importingFile.js");
...
//
// Your code here:
function exerciseEight(noun = "cat", adjective = "orange") {
  return `The ${noun} is ${adjective}`;
}
console.log("Exercise 8: ", exerciseEight("wall", "white"));
